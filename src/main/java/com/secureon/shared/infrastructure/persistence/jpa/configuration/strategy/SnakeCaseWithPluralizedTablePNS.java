package com.secureon.shared.infrastructure.persistence.jpa.configuration.strategy;
...
public class SnakeCaseWithPluralizedTablePNS implements PhysicalNamingStrategy {
    @Override
